...
class Visual:
    def __init__(self, root):
        ...
        self.label_xml_create_tab_4_arg2 = Label(self.frame_4, text='Время между заказами (сек)').place(x=15, y=145)
        self.entry_xml_create_tab_4_arg2 = ttk.Entry(self.frame_4, width=20, textvariable=xml_arg2_tab_4)
        self.entry_xml_create_tab_4_arg2.place(x=15, y=167)
        # Время до закрытия (сек)
        self.label_xml_create_tab_4_arg3 = Label(self.frame_4, text='Время до закрытия (сек)').place(x=15, y=189)
